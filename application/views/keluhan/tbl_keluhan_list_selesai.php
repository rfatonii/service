            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">DATA KELUHAN (SELESAI)</h3>
                    </div>
        ...
        <table class="table table-bordered table-striped" id="mytable">
            <thead>
                <tr>
					...
					<th width="250px">Tindak Lanjut</th>
					<th width="370px">Action</th>
                </tr>
            </thead>
                ...
                ?>
                        <tr>
                            ...
                            <td>
								...
								<!--<a href="<?php echo site_url(); ?>/keluhan/tindaklanjut/<?php echo $keluhan->kode_keluhan; ?>"><button type="button" class="btn btn-warning btn-sm"><i class="fa fa-check-square-o" aria-hidden="true"></i></button></a>-->
								<a href="<?php echo site_url(); ?>/keluhan/tindaklanjutedit/<?php echo $keluhan->kode_keluhan; ?>"><button type="button" class="btn btn-warning btn-sm">Edit</button></a>
