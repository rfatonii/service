        ...
        <table class="table table-bordered table-striped" id="mytable">
            <thead>
                <tr>
					...
					<th width="80px">Pelapor</th>
					<th width="130px">Ruangan</th>
					<!--<th width="90px">Lokasi</th>-->
					<!--<th width="120px">Unit Kerja</th>-->
                ...
                ?>
                        <tr>
                           ...
                           <!-- <td><?php// echo $keluhan->lokasi; ?></td>-->
							...
							<!--<td><?php //echo $keluhan->tindaklanjut; ?></td>-->
                            <td>
							<script>
                                            function openWin() {
                                              window.open("<?php echo site_url(); ?>/keluhan/cetak/<?php echo $keluhan->kode_keluhan; ?>","_blank","toolbar=yes, location=yes, directories=no, status=no, menubar=yes, scrollbars=yes, resizable=no, copyhistory=yes, width=1000, height=700");
                                            }
                                            </script>
								...
								<a href="<?php echo site_url(); ?>/keluhan/tindakanproses/<?php echo $keluhan->kode_keluhan; ?>"><button type="button" class="btn btn-warning btn-sm">Proses</button></a>
