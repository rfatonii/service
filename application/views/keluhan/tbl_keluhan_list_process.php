            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">DATA KELUHAN (PROSES)</h3>
                    </div>
                ...
                ?>
                        <tr>
                            ...
                            <td>
								...
								<a href="<?php echo site_url(); ?>/keluhan/tindaklanjut/<?php echo $keluhan->kode_keluhan; ?>"><button type="button" class="btn btn-success btn-sm">Tindaklanjut</i></button></a>
								<!--<a href="<?php// echo site_url(); ?>/keluhan/tindaklanjut/<?php// echo $keluhan->kode_keluhan; ?>"><button type="button" class="btn btn-success btn-sm">Edit</i></button></a>-->
