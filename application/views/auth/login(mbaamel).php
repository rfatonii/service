    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo base_url(); ?>/adminlte/index2.html"><b>SERVICE REPORT</b> <br>IT RS Syarif Hidayatullah</a>
            </div>
            <!-- /.login-logo -->
                ...
                <!-- <div class="row" style="margin-top: 20px;">
                    <div class="col-xs-12">
                        <div class="callout callout-info">
							...
							<!--
							<h4>Level Admin</h4>
                            <p><b>Username</b> : ari</p>
                            <p><b>Password</b> : ari</p>
							<br>-->
							<!-- <h4>Level Karyawan</h4>

                            <p><b>Username</b> : ameliarssh</p>
                            <p><b>Password</b> : ameliarssh</p>
