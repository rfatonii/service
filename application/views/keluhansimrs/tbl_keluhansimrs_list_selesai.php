            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">DATA KELUHAN SIM RS KHANZA (SELESAI)</h3>
                    </div>
                ...
                ?>
                        <tr>
                            ...
                            <td>
								...
								<a href="<?php echo site_url(); ?>/keluhansimrs/tindaklanjutedit/<?php echo $keluhan->kode_keluhansimrs; ?>"><button type="button" class="btn btn-warning btn-sm">Edit</button></a>
