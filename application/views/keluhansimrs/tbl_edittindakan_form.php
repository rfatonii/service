    ...
    <section class="content">
        <div class="box box-warning box-solid">
            <div class="box-header with-border">
                <h3 class="box-title">INPUT DATA TINDAK LANJUT KELUHAN SIM RS KHANZA</h3>
            </div>
		...
		<tr>
			<td colspan='2' width='200'><b><u>DATA TINDAK LANJUT DI ISI OLEH IT</u></b></td>
		</tr>
		<div class="form-group">
		...
		<tr><td></td>
			...
			<a href="<?php echo site_url('keluhansimrs/selesai') ?>" class="btn btn-info"><i class="fa fa-sign-out"></i> Kembali</a></td>
		</tr>
		</table>
		</form>
		</div>
