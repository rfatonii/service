            ...
            <div class="col-xs-12">
                <div class="box box-warning box-solid">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">DATA KELUHAN SIM RS KHANZA (PROSES)</h3>
                    </div>
...
if($this->session->userdata('id_user_level') == '1'){ // Jika role-nya admin
    ?>
		...
		<!--<?php// echo anchor(site_url('keluhansimrs/word'), '<i class="fa fa-file-word-o" aria-hidden="true"></i> Export Ms Word', 'class="btn btn-primary btn-sm"'); ?>-->
	</div>
                ...
                ?>
                        <tr>
                            ...
                            <td>
								...
								<a href="<?php echo site_url(); ?>/keluhansimrs/tindaklanjut/<?php echo $keluhan->kode_keluhansimrs; ?>"><button type="button" class="btn btn-success btn-sm">Tindaklanjut</button></a>
                        ...
                        <tr>
                            ...
                            <td>
								<?php if($keluhan->status==1){
									echo "<div class='btn btn-success btn-sm'>Diproses</div>"; 
									}else if($keluhan->status==2){ 
									echo "<div class='btn btn-warning btn-sm'>Selesai</div>";
									}else if($keluhan->status==3){ 
									echo "<div class='btn btn-danger btn-sm'>Diajukan</div>";
									}
								?>
                            </td>
							<td><?php echo $keluhan->id_keluhansimrs; ?></td>
