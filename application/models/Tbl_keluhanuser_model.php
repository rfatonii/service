...
class Tbl_keluhanuser_model extends CI_Model
{
    ...
    function json() {
		...
		$this->datatables->select('kode_keluhan,id_keluhan,tanggal_keluhan,nama_ruangan,lokasi,unit_kerja,uraian,merk,nama_jenisinventaris,kode_status,kode_operator,full_name,nama_status,nama_jenispekerjaan,nama_tingkatperbaikan');
        $this->datatables->from('tbl_keluhan');
	...
	function semua_keluhanuser(){
		...
		Where tbl_keluhan.kode_pelapor = '$kode' ORDER BY tbl_keluhan.kode_keluhan DESC");
        return $query->result();
      }
	  
	 function process_keluhan($kode=1){
        $query=$this->db->query("SELECT * FROM `tbl_keluhan` 
		LEFT join tbl_jenisinventaris on tbl_jenisinventaris.kode_jenisinventaris=tbl_keluhan.kode_jenisinventaris 
	 ...
	 function selesai_keluhan($kode=2){
        $query=$this->db->query("SELECT * FROM `tbl_keluhan` 
		LEFT join tbl_jenisinventaris on tbl_jenisinventaris.kode_jenisinventaris=tbl_keluhan.kode_jenisinventaris 
		Where tbl_keluhan.kode_status = '$kode' ORDER BY tbl_keluhan.kode_keluhan DESC");
        return $query->result();
...
/* End of file Tbl_keluhanuser_model.php */
/* Location: ./application/models/Tbl_keluhanuser_model.php */
